export default {
	about_description: '<div class="about"><div class="about__rules"><h3>Наші ресурси</h3><p><b>Сайт:</b><br>https://lampa.isroot.in</p><p><b>Telegram-бот:</b><br>@lampa_addon_bot</p><p><b>Telegram-канал:</b><br>@cosmos_tools</p><p><b>Зворотний зв’язок:</b><br>https://t.me/cosmos_tools?direct</p><h3>Що таке Lampa</h3><p>Lampa — це медіаоболонка для перегляду фільмів, серіалів, телеканалів та іншого контенту на телевізорах, приставках, телефонах і комп’ютерах.</p><p>Платформа підтримує різні джерела даних, зовнішні модулі та дозволяє адаптувати інтерфейс під власні потреби.</p><h3>Lampa Add-on</h3><p>Lampa Add-on — це набір додаткових інструментів, який розширює можливості Lampa та спрощує роботу з власним медіаконтентом.</p><p>Основна мета сервісу — зробити налаштування максимально простим, щоб більшість функцій працювали автоматично після кількох простих дій.</p><h3>Можливості сервісу</h3><ul><li>Тисячі безкоштовних телеканалів через IPTV та AceStream, включаючи телегід і архіви передач</li><li>Музичні відеокліпи та окремий розділ з контентом для дорослих</li><li>Додавання власних посилань на фільми, серіали, трансляції та інший медіаконтент</li><li>Передача фотографій, відео та музики через Telegram-бота для перегляду в Lampa</li><li>Підключення загальнодоступних папок Google Drive для доступу до своєї медіатеки</li><li>Перегляд фотографій у режимі слайдшоу з музичним супроводом</li></ul><h3>Швидкий старт</h3><ol><li>Авторизуйтеся в Lampa.</li><li>Вкажіть ту саму електронну пошту на сайті або в Telegram-боті.</li><li>Додавайте посилання, фотографії, відео та музику.</li><li>Відкрийте закладки плагіна Online.</li></ol></div></div>',
