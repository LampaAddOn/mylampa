export default {
	about_description: '<div class="about"><div class="about__rules"><h3>Нашы рэсурсы</h3><p><b>Сайт:</b><br>https://lampa.isroot.in</p><p><b>Telegram-бот:</b><br>@lampa_addon_bot</p><p><b>Telegram-канал:</b><br>@cosmos_tools</p><p><b>Зваротная сувязь:</b><br>https://t.me/cosmos_tools?direct</p><h3>Што такое Lampa</h3><p>Lampa — гэта медыяплатформа для прагляду фільмаў, серыялаў, тэлеканалаў і іншага кантэнту на тэлевізарах, прыстаўках, тэлефонах і камп'ютарах.</p><p>Платформа падтрымлівае розныя крыніцы дадзеных, знешнія модулі і дазваляе наладжваць інтэрфейс пад свае патрэбы.</p><h3>Lampa Add-on</h3><p>Lampa Add-on — гэта набор дадатковых інструментаў, які пашырае магчымасці Lampa і спрашчае працу з уласным кантэнтам.</p><p>Асноўная мэта сэрвісу — зрабіць наладу максімальна простай, каб большасць функцый працавала аўтаматычна.</p><h3>Што дадае сэрвіс</h3><ul><li>Уласныя IPTV і анлайн-трансляцыі</li><li>AceStream і magnet-спасылкі</li><li>Telegram-бот для перадачы фота, відэа і музыкі</li><li>Інтэграцыю з Google Drive</li><li>Слайд-шоў з фонавай музыкай</li><li>Абмен спасылкамі паміж карыстальнікамі</li><li>Тэлегід і архівы каналаў</li><li>Дадатковыя інструменты для кіравання медыякантэнтам</li></ul><h3>Хуткі старт</h3><ol><li>Аўтарызуйцеся ў Lampa.</li><li>Укажыце той жа email на сайце або ў Telegram-боце.</li><li>Дадавайце спасылкі, фота, відэа і музыку.</li><li>Адкрыйце закладкі плагіна Online.</li></ol></div></div>',
