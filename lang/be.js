export default {
	about_description: '<div class="about"><div class="about__rules"><h3>Нашы рэсурсы</h3><p><b>Сайт:</b><br>https://lampa.isroot.in</p><p><b>Telegram-бот:</b><br>@lampa_addon_bot</p><p><b>Telegram-канал:</b><br>@cosmos_tools</p><p><b>Зваротная сувязь:</b><br>https://t.me/cosmos_tools?direct</p><h3>Што такое Lampa</h3><p>Lampa — гэта медыяплатформа для прагляду фільмаў, серыялаў, тэлеканалаў і іншага кантэнту на тэлевізарах, прыстаўках, тэлефонах і камп’ютарах.</p><p>Платформа падтрымлівае розныя крыніцы дадзеных, знешнія модулі і дазваляе наладжваць інтэрфейс пад уласныя патрэбы.</p><h3>Lampa Add-on</h3><p>Lampa Add-on — гэта набор дадатковых інструментаў, які пашырае магчымасці Lampa і спрашчае працу з уласным медыякантэнтам.</p><p>Асноўная мэта сэрвісу — зрабіць наладу максімальна простай, каб большасць функцый працавала аўтаматычна пасля некалькіх простых дзеянняў.</p><h3>Магчымасці сэрвісу</h3><ul><li>Тысячы бясплатных тэлеканалаў праз IPTV і AceStream, уключаючы тэлегід і архівы перадач</li><li>Музычныя відэакліпы і асобны раздзел з кантэнтам для дарослых</li><li>Даданне ўласных спасылак на фільмы, серыялы, трансляцыі і іншы медыякантэнт</li><li>Перадача фатаграфій, відэа і музыкі праз Telegram-бота для прагляду ў Lampa</li><li>Падключэнне агульнадаступных папак Google Drive для доступу да сваёй медыятэкі</li><li>Прагляд фатаграфій у рэжыме слайд-шоў з музычным суправаджэннем</li></ul><h3>Хуткі старт</h3><ol><li>Аўтарызуйцеся ў Lampa.</li><li>Укажыце той жа email на сайце або ў Telegram-боце.</li><li>Дадавайце спасылкі, фатаграфіі, відэа і музыку.</li><li>Адкрыйце закладкі плагіна Online.</li></ol></div></div>',
